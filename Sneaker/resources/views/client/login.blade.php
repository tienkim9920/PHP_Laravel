            ...
            <div class="inputThongTin">
                <form action="/client/login" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        @if (isset($emailError))
                        <span style="color: red; padding-left: 0.8rem;"> {{ $emailError }}</span>
                        @endif
                    </div>
                    <div class="form-group">
                        ...
                        <span style="color: red; padding-left: 0.8rem;"> {{ $passwordError }}</span>
                        @endif
                    </div>
                        <button type="submit" class="btn btn-primary">Log In </button>
                    <div class="groupOption">
                        <a class="dangNhap" style="background-color: rgb(119, 193, 235); color: white; cursor: pointer;">Sign In</a>
                        <a class="dangNhap" href="/client/register">Sign Up</a>
                    </div>
                </form>
