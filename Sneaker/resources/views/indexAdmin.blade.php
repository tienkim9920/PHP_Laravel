                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                        class="text-dark"><?php echo $_SESSION['user']; ?></span> <i data-feather="chevron-down"
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="tableCarts.html" class="sidebar-link"><span
                                            class="hide-menu">
                                            Datatables Carts
                                        </span></a>
                                </li>
                                            ...
                                            <tr>
                                                <td class="border-top-0 px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img src="../assets/images/users/IMG_6225.jpg"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                                            <h5 class="text-dark mb-0 font-16 font-weight-medium">Nguyen
                                                                Kim Tien
                                                            </h5>
                                                            <span
                                                                class="text-muted font-14">tienkim9920@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="font-weight-medium text-dark border-top-0 px-2 py-4">$99K
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
