...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="/assets/images/users/IMG_6225.jpg" alt="user" class="rounded-circle"
                                    width="40">
                                <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                        class="text-dark">Nguyen Kim Tien</span> <i data-feather="chevron-down"
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="/admin/giohang/carts" class="sidebar-link"><span
                                            class="hide-menu">
                                            Datatables Carts
                                        </span></a>
                                </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Table Products</h4>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <div class="table-responsive products_data">
                ...
                <!-- order table -->
                <a href="/admin/sanpham/create" class="btn btn-primary">Create Product</a>
            </div>
            <!-- ============================================================== -->
            <!-- End Container fluid  -->
            <!-- ============================================================== -->
    ...
    <script>
        <?php foreach ($products as $product) { ?>
            $(document).on('click', '#submit<?php echo $product['id'] ?>', () => {

                $idProduct = $('#<?php echo $product['id'] ?>').val();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                            ...
                            $('.products_data').empty();
                            $('.products_data').html(response.viewProductsData);
                        }
                    }
                });
            })
