                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i data-feather="grid" class="feather-icon"></i><span class="hide-menu">Tables </span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="/admin/giohang/carts" class="sidebar-link"><span class="hide-menu">
                                            Datatables Carts
                                        </span></a>
                                </li>
                            </ul>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Create Products</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="/admin/sanpham/{{ $value->id }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group w-50">
                                        <label>Tên Sản Phẩm</label>
                                        <input type="text" class="form-control" name="tenSP" required="" value="{{ $value->tenSP }}">
                                    </div>
                                    <div class="form-group w-50">
                                        <label>Giá Sản Phẩm</label>
                                        <input type="text" class="form-control" name="giaSP" required="" value="{{ $value->giaSP }}">
                                    </div>
                                    <div class="form-group w-50">
                                        <label>Hình Ảnh 1</label>
                                        <input type="file" class="form-control-file" name="imgSP1" required>
                                    </div>
                                @endforeach
